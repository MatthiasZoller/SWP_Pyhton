...
config_path = "C:\\Users\\User1\\PycharmProjects\\SWP-Rubner\\SchereSteinPapier\\config.json"
...
def send_statistik(data):
    with open(config_path) as file:
        config = json.load(file)
    url = config['webserver_url']
